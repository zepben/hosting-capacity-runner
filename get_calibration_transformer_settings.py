...
CALIBRATION_ID = "<CALIBRATION ID/NAME>"  # ID of run to fetch calibration sets for
...
async def print_loop(argv):
    ...
    try:
        result = await eas_client.async_get_transformer_tap_settings(CALIBRATION_ID, feeder=None, transformer_mrid=None)
